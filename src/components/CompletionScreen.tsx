...
const CompletionScreen = ({ onRestart }: CompletionScreenProps) => (
  <main className="flex flex-col items-center gap-6 animate-fade-in max-w-lg mx-auto text-center">
    ...
    <div className="w-full space-y-3" role="list" aria-label="Skills you learned">
      {[
